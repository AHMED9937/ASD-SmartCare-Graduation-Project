...
Prerequisites: Flutter SDK (>=2.0), Dart SDK, Android Studio, Xcode, etc.
...
Populate with your AI server URL, Stripe keys, etc.
...
Submit PRs with descriptive titles and issue references.
