...
Build and test the app without installing Flutter locally using Docker.
...
| Static analysis | `docker compose up analyze` |
| Build APK | `docker compose up build-apk` |
| Interactive shell | `docker compose run --rm dev bash` |
| Full CI pipeline | `docker compose up ci` |

### Requirements

- Docker Desktop 4.0+ with **6GB+ RAM** allocated
- 15GB+ disk space for Flutter/Android SDK

> 📖 See [README_DOCKER.md](README_DOCKER.md) for complete Docker documentation including troubleshooting.
...
| Job | Trigger | Purpose |
|-----|---------|---------|
| Format | All pushes | Ensure code style consistency |
| Analyze | All pushes | Static analysis with 69+ lint rules |
| Test | All pushes | Run 69+ unit/widget tests |
| Build Debug | PRs only | Verify build works |
| Build Release | main + tags | Create signed APK/AAB |
| Deploy Firebase | main + tags | Distribute to testers |
| GitHub Release | Tags only | Create public release |

### Build Status

Check the [Actions tab](https://github.com/AHMED9937/ASD-SmartCare-Graduation-Project/actions) for current build status.

> 📖 See [docs/CI_CD_PIPELINE.md](docs/CI_CD_PIPELINE.md) for complete pipeline documentation.
...
[![Latest Release](https://img.shields.io/github/v/release/AHMED9937/ASD-SmartCare-Graduation-Project?include_prereleases&label=Download%20APK)](https://github.com/AHMED9937/ASD-SmartCare-Graduation-Project/releases/latest)

### Installation Methods

| Method | Description |
|--------|-------------|
| **GitHub Releases** | Download APK directly from [Releases](https://github.com/AHMED9937/ASD-SmartCare-Graduation-Project/releases) |
| **Firebase App Distribution** | Testers receive builds automatically via email |
...
|--------|---------|-------|
| `v{MAJOR}.{MINOR}.{PATCH}` | v1.2.3 | Semantic versioning |
| `build-{DATE}-{SHA}` | build-20241225-abc123 | Auto-releases from main |

> 📖 See [DEPLOYMENT.md](DEPLOYMENT.md) for complete deployment guide including Firebase setup.
