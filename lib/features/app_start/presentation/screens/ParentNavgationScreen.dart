import 'package:asdsmartcare/features/app_start/presentation/cubit/asd_cubit.dart';
    ...
    return BlocConsumer<AsdCubit, AsdStates>(
      ...
      builder: (context, state) {
        return Scaffold(
          ...
          child: AsdCubit.get(context).ParentBottomNavgation[AsdCubit.get(context).current_index],
