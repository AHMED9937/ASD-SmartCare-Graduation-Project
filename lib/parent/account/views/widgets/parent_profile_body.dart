...
class ParentProfileBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final parent = cubit.currentParent?.data;
  ...
  Widget _buildChildrenSection(String parentId) {
    return BlocProvider(
      create: (_) => ParentChildrenListCubit()..getParentChildrenList(parentId),
      child: BlocBuilder<ParentChildrenListCubit, ParentChildrenListStates>(
        builder: (context, state) {
          if (state is GetParentChildrenListLoadingStates) {
            return const Center(
              child: Padding(
