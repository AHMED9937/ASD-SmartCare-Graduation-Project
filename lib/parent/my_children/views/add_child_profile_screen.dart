...
class AddChildProfileForm extends StatelessWidget {
  const AddChildProfileForm({super.key});
      ...
      child: Column(
        children: [
          ...
          AppTextField(
            ...
            controller:
                ParentChildsListCubit.get(context).ChildNametextcontroller,
          ...
          AppTextField(
            ...
            controller:
                ParentChildsListCubit.get(context).ChildAgetextcontroller,
          ...
          DropdownButtonFormField<String>(
            ...
            // Use decoration consistent with AppTextField
            ...
            onChanged: (val) {
              if (val != null) {
                ParentChildsListCubit.get(context)
