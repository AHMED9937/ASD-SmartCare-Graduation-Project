import 'package:asdsmartcare/presentation/AfterLoginRootes/apphome/Education/Articles.dart';
...
class HomePage extends StatelessWidget {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
             IconButton(
          icon: Icon(Icons.menu, color: Color(0xFF133E87),size: 32,),
          onPressed: () {},
        ),
            LogoImage(60, 60),
            IconButton(
        ...
        child: Column(
          ...
          children: [
            ...
            GridView.count(
              ...
              children: [
                _buildServiceItem(
                    "lib/appassets/images/autism.png", "Autism Test",context,Placeholder()),
                _buildServiceItem("lib/appassets/images/child_progress.png",
                    "Child progress",context,Placeholder()),
                _buildServiceItem("lib/appassets/images/education.png",
                    "Educational Resources",context,Articles()),
                _buildServiceItem(
                    "lib/appassets/images/chatbot.png", "Chat bot Help",context,Placeholder()),
                _buildServiceItem("lib/appassets/images/medical.png",
                    "Medical and pharmacist",context,Placeholder()),
                _buildServiceItem("lib/appassets/images/charity.png",
                    "Cooperative charities",context,Placeholder()),
              ],
            ),
            SizedBox(height: 9),
 ...
 Widget Specialist() {
  ...
  Widget _buildServiceItem(String iconPath, String title,BuildContext context,Widget Navigate_to) {
