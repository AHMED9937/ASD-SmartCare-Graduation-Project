...
class ResendCodeLoadingState extends ParentSignUpState {}

class ResendCodeSuccessState extends ParentSignUpState {}

class ResendCodeErrorState extends ParentSignUpState {
  final String error;
