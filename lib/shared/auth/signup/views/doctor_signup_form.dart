        ...
        child: Column(
          children: [
            DropdownButtonFormField(
              ...
              icon: const Image(
                image: AssetImage(
                  'lib/appassets/images/VectorarrowDown.png',
              ...
              decoration: InputDecoration(
                prefixIcon: const Padding(
                  ...
                  child: Image(
                    image: AssetImage(
                      'lib/appassets/images/Vector.png',
                    ), // Path to your local image
              ...
              onChanged: (val) {
                if (val != null) {
                  DoctorSignUpCubit.get(context).specializationController.text =
                      val;
                }
              },
            ),
            ...
            AppTextField(
              ...
              controller: DoctorSignUpCubit.get(
                context,
