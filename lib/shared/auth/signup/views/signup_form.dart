          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                print(
                    ParentSignUpCubit.get(context).userNametextcontroller.text);
                print(ParentSignUpCubit.get(context).phonetextcontroller.text);
                print(ParentSignUpCubit.get(context).emailtextcontroller.text);
                print(
                    ParentSignUpCubit.get(context).passwordtextcontroller.text);
