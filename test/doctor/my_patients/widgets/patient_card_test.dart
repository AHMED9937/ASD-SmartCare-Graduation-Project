...
void main() {
  testWidgets('PatientCard displays parent and child information', (
    ...
    final parent = Parents(userName: 'John Doe', childs: [child]);

    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
          body: PatientCard(parent: parent, child: child, onTap: () {}),
        ),
      ),
    );
  ...
  testWidgets('PatientCard displays multiple children if present', (
    ...
    final parent = Parents(userName: 'John Doe', childs: [child1, child2]);

    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
          body: PatientCard(parent: parent, child: child1, onTap: () {}),
        ),
      ),
    );
