...
class MockChildrenListCubit extends MockCubit<ParentChildsListStates>
    implements ParentChildsListCubit {}
...
void main() {
  ...
  group('ParentProfileScreen', () {
    ...
    testWidgets('displays Success state with ParentProfileBody',
      ...
      when(() => mockProfileCubit.state)
          .thenReturn(GetParentDataSuccsessStates());
      when(() => mockProfileCubit.Cur_Parent).thenReturn(mockData);
